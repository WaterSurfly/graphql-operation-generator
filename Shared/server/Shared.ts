...
export type AuthQuery = { __typename?: 'Query', auth: { __typename?: 'AuthOutput', resultType: ResultType, token?: string | null, info: { __typename?: 'AccountInfoDto', accountId: string, loginId: string, createdTime: string, lastLoginTime: string } } };
